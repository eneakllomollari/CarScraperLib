...
from ..classes import Dealer, Vehicle
from ..consts import DATE_FORMAT, MASTER_TABLE_HEADER_FORMAT, SOLD_CAR_COL, AVAIL_CAR_COL, \
...
def get_history(path):
    ...
    :return: `dict` with `unique_identifier` as key and a list with the history as value
    """
    history_dict = {}
