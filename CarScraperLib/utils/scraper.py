...
from ..constants.consts import VIN, LISTING_ID, MAKE, MODEL, TRIM, BODY_STYLE, YEAR, PRICE, MILEAGE, CARS_COM_VEHICLE_HREF_FORMAT, \
...
def scrape_and_get_vehicle_list(zip_code, search_radius, target_state):
    """ TODO Add website functionality, currently only support `cars.com`
...
def _get_cars_com_response(url):
    ...
    for val in listings:
        ...
        try:
            ...
            pass
    raise ValueError('CARS.digitalData was not found in `_get_cars_com_response()`')
